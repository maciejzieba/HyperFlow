...
def add_args(parser):
    ...
    parser.add_argument('--model_type', type=str, default='HyperPointFlow')
    ...
    parser.add_argument('--start_var', type=float, default=1.,
                        help='Starting with that variance for spherical distribution.')

    parser.add_argument('--stop_var', type=float, default=0.01,
                        help='Stopping with that variance for spherical distribution.')
